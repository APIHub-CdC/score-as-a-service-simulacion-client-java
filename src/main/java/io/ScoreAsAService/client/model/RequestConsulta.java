...
public class RequestConsulta {
  ...
  public RequestConsulta nperscve(String nperscve) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RequestConsulta requestConsulta = (RequestConsulta) o;
    return Objects.equals(this.nperscve, requestConsulta.nperscve);
  }
  ...
  public String toString() {
    ...
    sb.append("class RequestConsulta {\n");
